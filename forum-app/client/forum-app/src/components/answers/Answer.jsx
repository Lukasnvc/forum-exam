import {Comment, CommentBottom, CommentTop, Delete, Like, StyledButtom, StyledForm, StyledMin, StyledShow, StyledTextArea, Wrapper} from "./styles"
            ...
            <Comment key={ans._id}>
              <CommentTop>
                {ans.user_id === userObject._id ? (
                  ...
                  <>{isLoggedIn &&
                      <> {isLiked(ans._id) ? <Like onClick={() => handleLike(ans._id)}><FaThumbsUp /></Like> : <Like onClick={() => handleLike(ans._id)}><FaRegThumbsUp /></Like>} </>}
                    </>
                )}
                <div>
